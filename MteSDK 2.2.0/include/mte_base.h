...
MTE_SHARED MTE_WASM_EXPORT
uint32_t mte_base_version_major(void);
MTE_SHARED MTE_WASM_EXPORT
uint32_t mte_base_version_minor(void);
MTE_SHARED MTE_WASM_EXPORT
uint32_t mte_base_version_patch(void);

/* Returns the count of status codes. */
MTE_SHARED MTE_WASM_EXPORT
uint32_t mte_base_status_count(void);
...
MTE_SHARED MTE_WASM_EXPORT
uint32_t mte_base_drbgs_sec_strength_bytes(mte_drbgs algo);

/* Returns the minimum/maximum personalization string size for the given
   algorithm. */
MTE_SHARED MTE_WASM_EXPORT
uint32_t mte_base_drbgs_personal_min_bytes(mte_drbgs algo);
MTE_SHARED
uint64_t mte_base_drbgs_personal_max_bytes(mte_drbgs algo);

/* Returns the minimum/maximum entropy size for the given algorithm. */
MTE_SHARED MTE_WASM_EXPORT
uint32_t mte_base_drbgs_entropy_min_bytes(mte_drbgs algo);
MTE_SHARED
uint64_t mte_base_drbgs_entropy_max_bytes(mte_drbgs algo);

/* Returns the minimum/maximum nonce size for the given algorithm. */
MTE_SHARED MTE_WASM_EXPORT
uint32_t mte_base_drbgs_nonce_min_bytes(mte_drbgs algo);
MTE_SHARED MTE_WASM_EXPORT
uint32_t mte_base_drbgs_nonce_max_bytes(mte_drbgs algo);

/* Returns the reseed interval for the given algorithm. */
MTE_SHARED
uint64_t mte_base_drbgs_reseed_interval(mte_drbgs algo);
...
MTE_SHARED MTE_WASM_EXPORT
void mte_base_drbgs_incr_gen_error(MTE_BOOL flag, uint32_t after);

/* Returns the count of verifier algorithms. */
MTE_SHARED MTE_WASM_EXPORT
uint32_t mte_base_verifiers_count(void);
...
MTE_SHARED MTE_WASM_EXPORT
uint32_t mte_base_ciphers_count(void);
...
MTE_SHARED MTE_WASM_EXPORT
uint32_t mte_base_ciphers_block_bytes(mte_ciphers algo);

/* Returns the count of hash algorithms. */
MTE_SHARED MTE_WASM_EXPORT
uint32_t mte_base_hashes_count(void);
